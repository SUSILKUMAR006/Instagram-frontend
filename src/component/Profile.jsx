...
function Profile() {
    ...
    useEffect(() => {
        // Fetch profile and followers data from static JSON
        fetch('/db.json')
    ...
    // Handle profile update (disabled in static mode)
    const UpdateHandle = async (e) => {
        e.preventDefault();
        toast.warning('Profile editing is disabled in static mode. Data is read-only.');
    };
                ...
                <div className="mt-10 text-white">
                    <div className="flex items-center">
                        ...
                        <div className="px-10 lg:pl-25">
                            <div className="flex">
                                <h1 className="text-lg mr-10 text-white font-semibold">{profile.username}</h1>
